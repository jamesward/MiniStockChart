#!/bin/sh
/home/jamesw/flex_sdk_4.1.0.16076-air_2.5/bin/mxmlc -target-player 10.1.0 -load-config /home/jamesw/flex_sdk_4.1.0.16076-air_2.5/frameworks/air-config.xml MiniStockChart.mxml 
